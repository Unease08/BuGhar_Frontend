        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
          ...
          <div className="col-span-4 sm:col-span-9">
            <div className="bg-white shadow rounded-lg p-4">
              <div className="bg-gradient-to-r from-blue-600 to-blue-900 p-6 rounded-lg shadow-lg h-[180px]">
              ...
              <div className="mt-10 ml-10">
                <h1 className="text-indigo-700 font-bold text-lg">
                  Personal details
                </h1>
                <p>Personal details are visible on your profile page</p>
              ...
              <div className="mt-10 ml-10">
                ...
                <p>Contact details are visible on your profile page</p>
                <div className="mt-5">
                  <div className="flex space-x-4">
                    <div className="flex-1">
                      <label
